package com.adp.au.stp;

import com.adp.au.stp.config.ApplicationProperties;
import com.adp.au.stp.config.DefaultProfileUtil;
...
public class StpApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(StpApp.class);

    private final Environment env;

    public StpApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(StpApp.class);
